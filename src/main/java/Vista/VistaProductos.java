...
public class VistaProductos extends javax.swing.JFrame {
    ...
    public VistaProductos() {
        initComponents();
        String ids[] = {"Nombre", "Precio", "ID", "Cantidad"};
    ...
    public void llenarTablaProductos() {
        DefaultTableModel modeloProductos = controlador.obtenerProductos();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        controlador.agregarProductoACarrito(filaSeleccionada, this);
    ...
    public Object[] obtenerFilaSeleccionada() {
        int filaSeleccionada = jTable1.getSelectedRow();
        if (filaSeleccionada != -1) {
            int columnas = jTable1.getColumnCount();
            Object[] fila = new Object[columnas];
            for (int i = 0; i < columnas; i++) {
                fila[i] = jTable1.getValueAt(filaSeleccionada, i);
            }
            return fila;
        }
        return null;
